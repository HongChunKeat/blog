...
CREATE TABLE `sw_setting_deposit` (
  ...
  `token_address` varchar(66) DEFAULT NULL COMMENT 'token',
  `network` int(11) DEFAULT 0 COMMENT 'refer to setting blockchain network',
  `address` varchar(255) DEFAULT NULL COMMENT 'Deposit Address',
...
CREATE TABLE `sw_setting_nft` (
  ...
  `token_address` varchar(66) DEFAULT NULL COMMENT 'token',
  `network` int(11) DEFAULT 0 COMMENT 'refer to setting blockchain network',
  `address` varchar(255) DEFAULT NULL COMMENT 'Withdraw Address',
